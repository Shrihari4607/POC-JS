	...
	<body>
		...
		<div id="site-content">
				...
				<div class="top-header">
					<div class="container">
						<a href="index.html" id="branding">
							<img src="../resources/images/logo.png" alt="Company Name" class="logo">
							<div class="logo-text">
						...
						<div class="right-section pull-right">
							<a href="#" class="phone"><img src="../resources/images/icon-phone.png" class="icon">+1 823 424 9134</a>
					
							<form action="#" class="search-form">
								<input type="text" placeholder="Search...">
								<button type="submit"><img src="../resources/images/icon-search.png" alt=""></button>
							</form>
						</div>
					</div> <!-- .container -->
				</div> <!-- .top-header -->
				...
				<div class="bottom-header">
					<div class="container">
						<div class="main-navigation">
							...
							<ul class="menu">
								<li class="menu-item"><a href="../resources/about.html">About us</a></li>
								<li class="menu-item"><a href="../resources/insurance.html">Insurance plans</a></li>
								<li class="menu-item"><a href="../resources/resource.html">Resources</a></li>
								<li class="menu-item"><a href="../resources/contact.html">Contact</a></li>
							</ul> <!-- .menu -->
						</div> <!-- .main-navigation -->
			...
			<div class="hero hero-slider">
				<ul class="slides">
					<li data-bg-image="../resources/dummy/slide-1.jpg">
						<div class="container">
					...
					<li data-bg-image="../resources/dummy/slide-2.jpg">
						<div class="container">
							<div class="slide-content">
								<h2 class="slide-title">Get your <strong>Life Insurance</strong></h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus quos cumque odio soluta harum error sequi laudantium, est nam perspiciatis eveniet maxime, esse possimus architecto sunt natus reprehenderit debitis fugit.</p>
					...
					<li data-bg-image="../resources/dummy/slide-3.jpg">
						<div class="container">
							<div class="slide-content">
								<h2 class="slide-title">Get your <strong>Life Insurance</strong></h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus quos cumque odio soluta harum error sequi laudantium, est nam perspiciatis eveniet maxime, esse possimus architecto sunt natus reprehenderit debitis fugit.</p>
			...
			<main class="main-content">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="offer caption-top">
									<img src="../resources/dummy/offer-tall.jpg" alt="offer 1">
									<div class="caption">
							...
							<div class="col-md-9">
								<div class="row">
									<div class="col-md-4">
										<div class="offer caption-bottom">
											<img src="../resources/dummy/offer-1.jpg" alt="offer 2">
											<div class="caption">
									...
									<div class="col-md-8">
										<div class="offer caption-bottom">
									<img src="../resources/dummy/offer-wide.jpg" alt="offer 3">
									<div class="caption">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="offer caption-bottom">
											<img src="../resources/dummy/offer-2.jpg" alt="offer 2">
											<div class="caption">
												<h3 class="offer-title">Curabitur vehicula</h3>
												<small>Conubia nostra per inceptos</small>	
											</div>
									...
									<div class="col-md-4">
										<div class="offer caption-bottom">
											<img src="../resources/dummy/offer-3.jpg" alt="offer 2">
											<div class="caption">
												<h3 class="offer-title">Curabitur vehicula</h3>
												<small>Conubia nostra per inceptos</small>	
											</div>
									...
									<div class="col-md-4">
										<div class="offer caption-bottom">
											<img src="../resources/dummy/offer-4.jpg" alt="offer 2">
											<div class="caption">
												<h3 class="offer-title">Curabitur vehicula</h3>
												<small>Conubia nostra per inceptos</small>	
											</div>
				...
				<div class="fullwidth-block">
					<div class="container">
						...
						<div class="row news-list">
							<div class="col-md-4">
								<div class="news">
									<figure><img src="../resources/dummy/featured-image-1.jpg" alt=""></figure>
									<div class="date"><img src="../resources/images/icon-calendar.png" alt="">03/09/2014</div>
									<h2 class="entry-title"><a href="#">Donec laoreet non nec aliquam pellentesque interdum</a></h2>
								</div>
							</div>
							<div class="col-md-4">
								<div class="news">
									<figure><img src="../resources/dummy/featured-image-2.jpg" alt=""></figure>
									<div class="date"><img src="../resources/images/icon-calendar.png" alt="">03/09/2014</div>
									<h2 class="entry-title"><a href="#">Donec laoreet non nec aliquam pellentesque interdum</a></h2>
								</div>
							</div>
							<div class="col-md-4">
								<div class="news">
									<figure><img src="../resources/dummy/featured-image-3.jpg" alt=""></figure>
				...
				<div class="fullwidth-block">
					<div class="container">
						...
						<div class="partners">
							<a href="#"><img src="../resources/dummy/money-logo.png" alt=""></a>
							<a href="#"><img src="../resources/dummy/nyt-logo.png" alt=""></a>
							<a href="#"><img src="../resources/dummy/forbes-logo.png" alt=""></a>
							<a href="#"><img src="../resources/dummy/wsj-logo.png" alt=""></a>
							<a href="#"><img src="../resources/dummy/bbs-logo.png" alt=""></a>
						</div> <!-- .partners -->
					</div> <!-- .container -->
				</div> <!-- .fullwidth-block -->
